    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url', models.CharField(blank=True, default='https://cdn.pixabay.com/photo/2015/04/23/22/00/tree-736885_1280.jpg', max_length=800, null=True)),
                ('category', models.CharField(blank=True, max_length=400, null=True)),
                ('bid', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='listing', to='house.bid')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('listing', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='house.listing')),
